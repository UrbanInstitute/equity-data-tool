content.pages.risks = [
    ...
    },
    {
        ...
        "content" : [
            ...
            "<strong>Collect the minimum necessary data for decisionmaking:</strong> Interviewees emphasized that cities define up front how each data point that is collected will be used to inform a specific decision point or research question. According Pittsburgh Director of Innovation and Performance Santiago Garces, program designers should tell themselves “What is the minimum amount of data that I need to make my decision? I don’t want to collect more than I need to make my decision or do my analysis because it creates more risk of identification.”",
    ...
    {
        "contentType" : "paragraph",
        "content" : "As the volume of data collected by cities grows, city data offices need tools and resources to help them balance openness and transparency of data with resident privacy. The <span class = \"frameworkHighliight\"><a href = \"https://docs.google.com/document/d/1528rqTjzKWwk4s2xKuPf7ZJg-tLlRK8WcMZQbicoGTM/edit\" target = \"_blank\">OpenNorth Open Smart Cities Guide</a></span> argues that the smart city should be “<a href = \"https://opendatacharter.net/principles/\" target = \"_blank\">open by default</a>” given the <a href = \"https://opendatapolicyhub.sunlightfoundation.com/why-open-data/\" target = \"_blank\">many benefits of open data for residents and city governments</a>. Some data officials we interviewed expressed uncertainty regarding how to adhere to open data principles and state sunshine laws while protecting resident privacy as the growing amount of publicly available data <a href = \"https://www.census.gov/newsroom/blogs/random-samplings/2019/02/census_bureau_adopts.html\" target = \"_blank\">increases reidentification concerns</a>."
    },
    {
        "contentType" : "paragraph",
